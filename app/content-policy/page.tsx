...
import { CHECKED_RANGE_LABEL, SITE_NAME } from "@/lib/site";
...
const sections: { t: string; body: string[] }[] = [
  ...
  },
  {
    t: "2. 確認日の運用",
    body: [
      `各業者ページ・比較表には確認日を明記します（現行の掲載社の確認日: ${CHECKED_RANGE_LABEL}の間で各社ごとに記載）。条件は変更される場合があるため、再確認を行った際は確認日を更新します。確認日から時間が経過している情報は、その日付時点の情報としてお読みください。`,
    ],
  },
  {
    t: "3. 口コミ・体験談を創作しない",
